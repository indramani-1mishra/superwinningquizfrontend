...
function Home() {
  ...
  return (
    <div className={`${isMobile ? "flex flex-col items-center text-white px-4 text-center  min-h-screen mt-4" : "flex flex-col items-center justify-center h-[100vh] text-center text-white opacity-75 px-4"}`}>
